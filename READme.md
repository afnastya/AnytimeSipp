...
* [Алгоритм Sipp и Anytime Sipp](#алгоритм-sipp-и-anytime-sipp)
* [Чекер](#чекер)
...
### Пререквизиты
GCC 10 или выше
Apple LLVM version 11.0.3 (clang-1103.0.32.62) или выше
...
11...
```
После слов height и width положительные числа, равные высоте и ширине карты соответственно. После строки "map" идет описание карты: количество строк равно высоте карты, количество символов в каждой строке равно ширине карты. Символ '.' означает пустую клетку, любой другой непробельный символ - занятая клетка.
